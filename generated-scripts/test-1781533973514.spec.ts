...
test('Autonomously generated AI test', async ({ page }) => {
  ...
  // Step 3: První krok je zjistit, zda se na stránce nachází další tlačítka a jak fungují. Zde vidím tlačítko 'Detail' a jeho vlastnosti.
  await page.click('[data-qa-id="2"]');
  // Step 4: První krok je zjistit, zda se na stránce nachází další tlačítka a jak fungují. Zde vidím tlačítko 'Jméno' a jeho vlastnosti. Přejděme na detailnější analýzu.
  await page.fill('[data-qa-id="2"]', 'Zkušební text');
