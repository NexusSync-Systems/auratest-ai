...
async function extractInteractiveElements(page) {
  try {
    return await page.evaluate(() => {
      ...
      // ⚡ Bolt: Nahrazeno pomalé querySelectorAll a Array.from za rychlé getElementsByTagName a for cyklus
      // s pre-alokovaným polem pro maximální výkon v Playwright evaluate() kontextu.
      ...
      try {
        performanceMetrics = await page.evaluate(() => {
          ...
          return {
            ...
            // ⚡ Bolt: Nahrazeno pomalé querySelectorAll za rychlé getElementsByTagName pro získání počtu elementů.
