...
async function extractInteractiveElements(page) {
  try {
    return await page.evaluate(() => {
      ...
      // ⚡ Bolt: Fast live DOM collection and pre-allocated static array mapping
      // Replacing slow Array.from(document.querySelectorAll('*'))
...
export async function extractInternalLinks(startUrl) {
  ...
  try {
    ...
    const hrefs = await page.evaluate(() => {
      // ⚡ Bolt: Fast DOM retrieval and static array mapping for 'a' elements
