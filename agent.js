...
async function extractInteractiveElements(page) {
  try {
    return await page.evaluate(() => {
      ...
      // ⚡ Bolt: Fast array conversion from HTMLCollection without Array.from or CSS selector parsing
      ...
      try {
        performanceMetrics = await page.evaluate(() => {
          ...
          return {
            ...
            // ⚡ Bolt: Use getElementsByTagName for faster DOM querying without CSS selector parsing
