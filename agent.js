...
export async function auditGreenAndResidency(url) {
  ...
  try {
    ...
    if (navigationError) {
      ...
      const zmereno = objemMereni.vysledek();
      return {
        success: true,
        url,
        navigationError,
        green: {
          ...odhadniEmise(null, {
            zmerenychPozadavku: zmereno.zmerenychPozadavku,
            nezmerenychPozadavku: zmereno.nezmerenychPozadavku,
          }),
          // Navigace selhala, takže doménu auditovaného webu neznáme
          // a rozdělit objem nejde. `rozdeleno: false` to řekne nahlas.
          puvod: rozdelPodlePuvodu(zmereno.bajtuPodleDomen, null),
        },
        residency: {
          totalDomains: 0,
          locations: [],
    ...
    return {
      ...
      green: {
        ...odhadniEmise(zmereno.totalBytes, {
          zmerenychPozadavku: zmereno.zmerenychPozadavku,
          nezmerenychPozadavku: zmereno.nezmerenychPozadavku,
        }),
        ...
        // s tím může udělat.
        puvod: rozdelPodlePuvodu(zmereno.bajtuPodleDomen, originHost),
      },
      residency: {
